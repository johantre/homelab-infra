...
Fix this with hands-off installation, on separate volume that assures ssh-server, ... nopass is configured during silent ubuntu install/flash

# Commands to run from controller
## From the controller
